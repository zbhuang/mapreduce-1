...
See the [MapReduce C++ Library](http://craighenderson.co.uk/papers/software_scalability_mapreduce/library.php) page for more information, and a sample program.
